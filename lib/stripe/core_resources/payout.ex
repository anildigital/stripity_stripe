defmodule Stripe.Payout do
  ...
  @type failure_code :: :account_closed | :account_frozen | :bank_account_restricted
  | :bank_ownership_changed | :could_not_process | :debit_not_authorized | :insufficient_funds
  | :invalid_account_number | :invalid_currency | :no_account | :unsupported_card | atom
